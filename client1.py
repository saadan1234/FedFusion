...
class FlowerClient(NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        print(f"Starting Fit Function: Parameters: {type(parameters)} {parameters}")
...
if __name__ == "__main__":
    ...
    client = client_fn(partition_id=0, num_partitions=3, local_epochs=2, batch_size=32, learning_rate=0.1)
    start_client(
